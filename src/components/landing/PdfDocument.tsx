  ...
  return (
    <div ref={ref} className="bg-white text-ink font-sans">
      ...
      <div data-pdf-page data-pdf-bg="#0a0a0a" className={`${PAGE} bg-ink text-paper`}>
        ...
        <div className="absolute right-14 top-24 w-[260px] h-[340px] overflow-hidden">
          <img src={irinaAsset.url} alt="" crossOrigin="anonymous" className="w-full h-full object-cover grayscale" />
        </div>
